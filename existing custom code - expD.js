<script>
    ...
    //add selector to change progress bar for offer and registration page 
    progressBar: ".att_progress_section",
    ...
    //Height of progressbar
     ...
     //margin of progressBar
     progressBarMargin:"0px auto"

     //max-width of progressBar
     progressBarWidth : "91.8rem"
...
var css = `
  ...
  //begin for offer page and register page
  .att_progress_section{
    margin:  `+att_config.progressBarMargin+`;
    max-width:`+ att_config.progressBarWidth+`;
  }
  //end for offer page and register page
...
// =========================== USER DEFINED CONFIGURATION ENDS FOR DEFINING SPA STEPS ===========================
      ...
      for(let i = 0; i<urlsArr.length; i++){
          ...
          if(document.location.href.indexOf(urlsArr[i]) > -1){
            ...
            progressSection.setAttribute("style","max-width: 91.8rem;margin: 0px auto");
            break;
          }
      }
      ...
      let progressSection = document.createElement("div");
      progressSection.classList.add("att_progress_section");
      for(let i = 0; i<urlsArrNew.length; i++){

          if(document.location.href.indexOf(urlsArrNew[i]) > -1){
            progressSection.innerHTML = steps[i];
            progressBarContainer.prepend(progressSection);
            progressSection.setAttribute("style","max-width: 91.8rem;margin: 0px auto");
            break;
